...
const CDN_MANIFEST = "https://cdn.jsdelivr.net/npm/agentdocs@latest/corpus/manifest.json";
const CDN_CHANGELOG = "https://cdn.jsdelivr.net/npm/agentdocs@latest/CHANGELOG.md";
